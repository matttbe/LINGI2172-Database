...
CREATE TABLE Car (carId INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , name TEXT NOT NULL, height INTEGER DEFAULT 0, fuel INTEGER DEFAULT 0, user INTEGER NOT NULL, latitude DOUBLE, longitude DOUBLE, FOREIGN KEY(user) REFERENCES User(userId), FOREIGN KEY(fuel) REFERENCES Fuel(fuelId));
INSERT INTO "Car" VALUES(1,"My car",162,1,1,NULL,NULL);
INSERT INTO "Car" VALUES(2,"My beautiful car",165,3,1,50.667408,4.62202);
INSERT INTO "Car" VALUES(3,"My tailor is rich in my car",0,0,2,50.667408,4.62202);
...
CREATE TABLE "History" ("user" INTEGER PRIMARY KEY  NOT NULL ,"start" DATETIME NOT NULL  DEFAULT (null) ,"end" DATETIME NOT NULL  DEFAULT (null) ,"parking" INTEGER NOT NULL );
INSERT INTO "History" VALUES(1,'2007-01-01 10:00:00','2007-01-01 11:00:00',1);
